# Auto-generated wrapper for app/pagina/comparaciones.py
...
orig_path = Path(__file__).with_name("comparaciones.orig.py")
spec = importlib.util.spec_from_file_location("comparaciones_orig", str(orig_path))
