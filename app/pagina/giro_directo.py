# Auto-generated wrapper for app/pagina/giro_directo.py
...
orig_path = Path(__file__).with_name("giro_directo.orig.py")
spec = importlib.util.spec_from_file_location("giro_directo_orig", str(orig_path))
