...
def run(filters: Dict[str, Any], df_filtered: Optional[pd.DataFrame], df_all: pd.DataFrame):
    """
    Entrypoint que prepara el contexto, muestra sidebar de filtros y ejecuta los bloques en orden.
    """
    ...
    # common paths
    ctx['giro_path'] = r"C:/REPS/data/giro.parquet"
    ctx['censo_path'] = r"C:/REPS/data/censo.csv"
    ctx['sugeridos_path'] = r"C:/REPS/data/sugeridos.csv"
